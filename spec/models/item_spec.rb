  ...
  describe '出品登録' do
    ...
    describe '出品登録' do
      ...
      context '出品ができないとき' do
        ...
        it 'scheduled_delivery_idが空欄だと登録できないこと' do
        ...
        it 'priceが¥9999999以上だと登録できないこと' do
          @item.price = 10_000_000
          @item.valid?
          expect(@item.errors.full_messages).to include('Price must be less than or equal to 9999999')
        end

        it 'priceが全角数字だと保存可能できないこと' do
          @item.price = '１１１１'
          @item.valid?
        ...
        it 'scheduled_delivery_idが1だと登録できないこと' do
